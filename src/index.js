...
global["openFile"] = (windowIsPristine) => {
  ...
  dialog.showOpenDialog(
    {
      properties: ["openFile"],
      filters: [{ name: FILE_EXT, extensions: [FILE_EXT] }],
    },
    (filePaths) => {
      if (filePaths) {
...
function openFileFromPath(path) {
  ...
  BrowserWindow.getFocusedWindow().webContents.send("fileOpened", {
    fileName,
    data,
    path,
  });
  ...
  const fileMenu = {
    ...
    submenu: [
      ...
      { type: "separator" },
      {
        ...
        accelerator: "Cmd+S",
        click: () =>
          BrowserWindow.getFocusedWindow().webContents.send("menu.saveFile"),
      },
      {
        label: "Save As...",
        accelerator: "Shift+Cmd+S",
        click: () =>
          BrowserWindow.getFocusedWindow().webContents.send("menu.saveFileAs"),
      },
      { type: "separator" },
      { role: "close" },
    ],
  ...
  const viewMenu = {
    ...
    submenu: [
      ...
      },
      {
        ...
        type: "checkbox",
        checked: state.cursorFollowing,
        click: () =>
          BrowserWindow.getFocusedWindow().webContents.send(
            "menu.editorToggleCursorFollowing"
          ),
      },
      { type: "separator" },
      {
        ...
        click: () =>
          BrowserWindow.getFocusedWindow().webContents.send("menu.fontSizeUp"),
      },
      {
        label: "Decrease Zoom",
        accelerator: "Command+-",

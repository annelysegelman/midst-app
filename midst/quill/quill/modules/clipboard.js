...
const { AlignAttribute, AlignStyle } = require('../formats/align');
const { BackgroundStyle } = require('../formats/background');
const CodeBlock = require('../formats/code');
const { ColorStyle } = require('../formats/color');
const { DirectionAttribute, DirectionStyle } = require('../formats/direction');
const { FontStyle } = require('../formats/font');
const { SizeStyle } = require('../formats/size');
...
module.exports = { default: Clipboard, matchAttributor, matchBlot, matchNewline, matchSpacing, matchText };
